...
[![](https://img.shields.io/github/v/release/hansen1018/3x-ui.svg)](https://github.com/MHSanaei/3x-ui/releases)
[![](https://img.shields.io/github/actions/workflow/status/hansen1018/3x-ui/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/hansen1018/3x-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/hansen1018/3x-ui/total.svg)](#)
...
```
bash <(curl -Ls https://raw.githubusercontent.com/hansen1018/3x-ui/master/install.sh)
```
...
```
VERSION=v1.7.9 && bash <(curl -Ls "https://raw.githubusercontent.com/hansen1018/3x-ui/$VERSION/install.sh") $VERSION
```
...
wget https://github.com/hansen1018/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. **Clone the Project Repository:**
   ...
   ```sh
   git clone https://github.com/hansen1018/3x-ui.git
   cd 3x-ui
   ```
...
[![Stargazers over time](https://starchart.cc/hansen1018/3x-ui.svg?variant=adaptive)](https://starchart.cc/MHSanaei/3x-ui)
